from sqlalchemy import String, DateTime, Boolean, Integer, ForeignKey, UniqueConstraint, Enum, CheckConstraint, Index, func
...
class Ban(Base):
  ...
  __table_args__ = (
    CheckConstraint( # Проверяем поле с помощью запроса
    ...
    Index ( # Исключает более 1 активного бана у пользователя. 
      "uq_active_ban",
      "user_id",
      unique=True,
      postgresql_where=(
